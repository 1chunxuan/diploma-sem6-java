...
//delegation for encapsulation this class
 ...
 */
public class P2Q1_delegation extends JFrame{
    ...
    public P2Q1_delegation(){
        ...
        button1.addActionListener(new redButtonListener());
        button2.addActionListener(new greenButtonListener());
        button3.addActionListener(new blueButtonListener());
...
class redButtonListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e){
        JOptionPane.showMessageDialog(null, "You pressed the red button.");
    }
}

class greenButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent e){
        JOptionPane.showMessageDialog(null, "You pressed the green button.");
    }
}

class blueButtonListener implements ActionListener{
    public void actionPerformed(ActionEvent e){
        JOptionPane.showMessageDialog(null, "You pressed the blue button.");
    }
}